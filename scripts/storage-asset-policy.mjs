...
export const storageAssetPolicy = Object.freeze([
  ...
  },
  {
    ...
    currentReset: { entrypoint: 'task context reset and failClosedTaskCapabilities', coverage: ['selectedTask', 'taskList capabilities', 'assignment candidates'], status: 'COMPLETE' },
    requiredResetTriggers: ['SESSION_END', 'ACTOR_CHANGE', 'TASK_CONTEXT_CHANGE', 'PERMISSION_DENIED', 'RESOURCE_NOT_FOUND'],
    staleGuard: { strategy: 'SESSION_REVISION_ACTOR_REQUEST_VERSION_PROJECT_CONTEXT', tokens: ['sessionRevision', 'actorId', 'taskLoadVersion', 'taskWriteRevision', 'selectedProjectId', 'currentContextKey'], status: 'COMPLETE' },
    resetIntegrationStatus: 'COMPLETE',
